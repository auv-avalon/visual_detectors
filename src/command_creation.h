...
class CommandCreator{
	...
	base::AUVPositionCommand centerBuoyHeadingFixed(feature::Buoy &buoy, base::samples::RigidBodyState rbs, double desired_buoy_depth = -2.4, double maxX = 0.2, double target_heading = 0, double headingFactor = 1.0);
